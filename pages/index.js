  ...
  <div className="max-w-4xl mx-auto text-center">
    <div className="bg-slate-800 p-8 md:p-12 rounded-2xl border-t-4 border-blue-500 shadow-2xl transition-all hover:shadow-blue-500/10">
      ...
      <p className="text-xl text-slate-300 leading-relaxed mb-10 font-medium max-w-3xl mx-auto">
        To eliminate "microwaved" websites. We provide the elite technical integrity and speed required to dominate digital markets at a price which won't force you to take out a second mortgage on your home.
      </p>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            ...
            <div className="p-8 border border-slate-800 rounded-2xl hover:border-blue-400 transition group bg-slate-800/50">
              ...
              <p className="text-slate-400 text-lg leading-relaxed">
                We skip the gimmicks and focus on <span className="text-white font-normal">technical integrity</span>. We build lean, high-performance code that search engines prioritize. SiteIQ ensures your digital presence matches your professional caliber.
              </p>
            </div>
      ...
      {/* ABOUT SECTION - NOW MOVED ABOVE THE CTA */}
      ...
      {/* CONTACT SECTION - Header removed for a cleaner look */}
      <section id="contact" className="py-24 px-6 bg-blue-500">
        <div className="max-w-4xl mx-auto">
          <p className="text-center text-blue-100 mb-12 text-xl font-bold uppercase tracking-widest">
            Direct to James. Please include up-to-date contact information. I will get back to you within 24 hours.
          </p>
          ...
          <form action="https://api.web3forms.com/submit" method="POST" className="grid md:grid-cols-2 gap-4 text-left">
            ...
            <div className="space-y-2">
              ...
              <input type="email" name="email" required placeholder="chucknorris@example.com" className="w-full p-4 rounded-xl bg-white text-slate-900 outline-none transition focus:ring-4 focus:ring-blue-300" />
            </div>
      ...
      <footer className="py-12 border-t border-slate-800 text-center">
        <div className="max-w-3xl mx-auto flex items-center justify-center gap-12">
          <div className="text-slate-500 text-lg text-right space-y-2 font-bold">
